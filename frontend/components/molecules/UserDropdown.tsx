...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="relative inline-flex  items-center justify-center h-11 w-11 rounded-full text-gray-500 dark:text-gray-400">
          <svg
      ...
      >
        <div>
          <span className="block dark:text-white font-medium text-gray-700 text-theme-sm">
            Siti Nurhaliza
          </span>
        ...
        <div className=" pt-1 pb-1 border-b border-gray-200"></div>
