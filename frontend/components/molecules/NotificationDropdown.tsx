    ...
    <div className="relative">
      ...
      >
        ...
        <span className="relative inline-flex">
          {/* badge */}
          <span
            className={`absolute -right-1 -top-1 z-10 h-2 w-2 rounded-full bg-orange-400 ${
        ...
        <span className="block mr-1 font-medium text-theme-sm">Alert</span>
      </button>
      <Dropdown
        isOpen={isOpen}
      ...
      >
        ...
        <ul className="  flex flex-col max-h-100 h-auto overflow-y-auto custom-scrollbar">
